...
class adder_sequence extends uvm_sequence;
    `uvm_object_utils(adder_sequence) // add to uvm_factory (not component)
...
class adder_agent extends uvm_agent;
    ...
    adder_driver  a_drv;
    adder_monitor a_mon;
    uvm_sequencer #(adder_seq_item) a_sqr; // class name insert
...
class adder_environment extends uvm_env;
    `uvm_component_utils(adder_environment) // add adder_environment to uvm_factory
    ...
    virtual function void connect_phase(uvm_phase phase);
        super.connect_phase(phase);
        a_agt.a_mon.send.connect(a_scb.recv); // mon(send) <-> scb(receive) connect
    endfunction
endclass

class adder_test extends uvm_test;
    `uvm_component_utils(adder_test) // add adder_test to uvm_factory
